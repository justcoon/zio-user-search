package c.user.search.route

import cats.syntax.semigroupk._
import c.user.search.implicits.Throwable._
import c.user.search.model.database.User
import c.user.search.model.response.{
  BadRequestResponse,
  ErrorResponse,
  InternalServerErrorResponse,
  NotFoundResponse
}
import c.user.search.model.{DBFailure, ExpectedFailure, NotFoundFailure}
import c.user.search.module.db._
import c.user.search.module.logger.{Logger, _}
